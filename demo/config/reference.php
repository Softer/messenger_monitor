 ...
 *     },
 * }
 * @psalm-type SoftLabMessengerMonitorConfig = array{
 *     supervisor?: array{
 ...
 *         table_name?: scalar|Param|null, // Messenger messages table name // Default: "messenger_messages"
 *         names?: list<scalar|Param|null>,
 *     },
 *     history?: array{
 *         enabled?: bool|Param, // Enable message processing history recording // Default: true
 *         table_name?: scalar|Param|null, // Table name for history records // Default: "messenger_monitor_history"
 *     },
 *     api?: array{
 *         enabled?: bool|Param, // Enable JSON API endpoints // Default: false
 *         prefix?: scalar|Param|null, // API route prefix // Default: "/api/messenger-monitor"
 *     },
 * }
 ...
 *     soft_lab_messenger_monitor?: SoftLabMessengerMonitorConfig,
 *     "when@dev"?: array{
 *         imports?: ImportsConfig,
 *         parameters?: ParametersConfig,
 *         services?: ServicesConfig,
